...
@section('breadcrumbs', 'Chỉnh sửa danh mục')

@section('content')
<div class="main-header clearfix">
  <div class="page-title">
    <h3 class="no-margin">Chỉnh sửa danh mục</h3>
  </div>
</div>
    ...
    <div class="panel-body">
        {!! Form::model($category,['method' => 'PATCH','route'=>['categories.update' , $category->id], 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group {{ ($errors->has('color')) ? 'has-error' : '' }}">
                ...
                <div class="col-sm-7">
                    {!! Form::text('color', $category->color, ['class'=>'form-control', 'id' => 'color']) !!}
            ...
            <div class="col-sm-5 pull-right">
                ...
                <a href="{{ Route('categories.index') }}" class="btn btn-danger btn-sm bounceIn " role="button">Hủy</a>
            </div>
        {!! Form::close() !!}
    </div><!-- /panel-body -->
</div><!-- /panel -->
