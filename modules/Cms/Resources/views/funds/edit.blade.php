...
<div class="panel panel-default">
    ...
    <div class="panel-body">
          {!! Form::model($fund,['method' => 'PATCH','route'=>['funds.update' , $fund->id], 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group {{ ($errors->has('content')) ? 'has-error' : '' }}">
                ...
                <div class="col-sm-7">
                    {!! Form::textarea('content', $fund->content, ['class'=>'form-control', 'rows' => 4]) !!}
            ...
            <div class="form-group {{ ($errors->has('date')) ? 'has-error' : '' }}">
                ...
                <div class='col-sm-7'>
                    <div class='input-group date' id='datetimepickers'>
                        {!! Form::input('text','date', ($fund->date == '0000-00-00 00:00:00' ) ? null : \Carbon\Carbon::parse($fund->birthday)->format('d/m/Y'),
